...
- `docs/mechanical_score_update.md`: public description of the official Mechanical scoring update.
- `pyproject.toml`: package metadata and runtime dependencies.
- `README.md`: this short participant guide.

No dataset files, training reports, split audits, organizer tools, tests, or private documentation bundles are included in this devkit ZIP.
...
The official Mechanical score uses the updated context-aware method described
in `docs/mechanical_score_update.md`; exact hidden-test masks remain private during the competition.
